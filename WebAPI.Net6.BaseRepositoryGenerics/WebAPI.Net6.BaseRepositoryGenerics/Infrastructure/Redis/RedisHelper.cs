...
namespace WebAPI.Net6.BaseRepositoryGenerics.Infrastructure.Redis
{
    public class RedisHelper
    {
        ...
        /// 设置自定义键
        /// </summary>
        public string CustomKeyPrefix { get; set; } = "My_";

        #region 构造函数

        public RedisHelper(int databaseNumber = 0)
            : this(databaseNumber, null)
        {
        }

        public RedisHelper(int databaseNumber, string readWriteHosts)
        {
            DatabaseNumber = databaseNumber;
            redis = string.IsNullOrWhiteSpace(readWriteHosts) ?
