...
{
    public class CreateErrorMessageCommandHandler : IRequestHandler<CreateErrorMessageCommand, ErrorMessageCreateResponse>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateErrorMessageCommandHandler"/> class.
        /// </summary>
        /// <param name="errorMessageService">The error message service.</param>
        /// <param name="logger">The logger.</param>
        public CreateErrorMessageCommandHandler(IErrorMessageService errorMessageService
            , ILogger<CreateErrorMessageCommandHandler> logger)
        {
        ...
        /// <returns></returns>
        public async Task<ErrorMessageCreateResponse> Handle(CreateErrorMessageCommand request, CancellationToken cancellationToken)
        {
            var response = new ErrorMessageCreateResponse();
            ...
            finally
            {
                ...
                sysLog.speed = speed;
                sysLog.msg = msg;
                sysLog.handler = "CreateErrorMessageCommandHandler";
